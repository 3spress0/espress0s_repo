...
export function seedCatalog(db) {
  const tx = db.transaction(() => {
    ...
    const moreTools = [
      ...
      ['Free Download Manager', 'fdm-win', 'windows', 'exe', ['6.24', '6.26'], 'networking', 'applications', (v) => `https://files2.freedownloadmanager.org/6/latest/fdm_x64_setup.exe`, 40, 50, 'Download manager with torrent support.'],
      ...
      ['Termux (F-Droid APK)', 'termux-apk', 'windows', 'zip', ['0.118.0'], 'networking', 'applications', () => 'https://f-droid.org/en/packages/com.termux/', 120, 140, 'Android terminal emulator & Linux env (for completeness in archives).'],
